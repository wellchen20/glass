...
public class FeccControlBar {
    private static final String TAG = "FeccControlBar";
    ...
    public FeccControlBar(ConstraintLayout parent, UserActionListener actionListener) {
        this.parent = parent;
        this.actionListener = actionListener;
        mFeccLeftBtn = parent.findViewById(R.id.fecc_left);
        mFeccRightBtn = parent.findViewById(R.id.fecc_right);
        mFeccUpBtn = parent.findViewById(R.id.fecc_up);
        mFeccDownBtn = parent.findViewById(R.id.fecc_down);
        mFeccControl = parent.findViewById(R.id.fecc_control);
        mFeccControlBg = parent.findViewById(R.id.fecc_control_bg);
        mFeccControlBgLeft = parent.findViewById(R.id.fecc_control_bg_left);
        mFeccControlBgRight = parent.findViewById(R.id.fecc_control_bg_right);
        mFeccControlBgUp = parent.findViewById(R.id.fecc_control_bg_up);
        mFeccControlBgDown = parent.findViewById(R.id.fecc_control_bg_down);
        mFeccPanView = parent.findViewById(R.id.fecc_pan);

        zoomInAdd = parent.findViewById(R.id.zoom_in_add);
        zoomInPlus = parent.findViewById(R.id.zoom_out_plus);
...
//        }
    ...
    public void layoutByOrientation() {
        if (parent.getContext().getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) mFeccControl.getLayoutParams();
            ...
            mFeccControl.setLayoutParams(layoutParams);
            mFeccControl.setGravity(Gravity.CENTER_VERTICAL);
        } else if (parent.getContext().getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) mFeccControl.getLayoutParams();
            layoutParams.width = RelativeLayout.LayoutParams.MATCH_PARENT;
            layoutParams.height = RelativeLayout.LayoutParams.WRAP_CONTENT;
            ...
            mFeccControl.setGravity(Gravity.CENTER_HORIZONTAL);
        }
    }
